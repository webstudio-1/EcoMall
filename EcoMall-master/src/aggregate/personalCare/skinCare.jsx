...
const customStyles = `
  ...
  .btn-cart {
    background-color: #46c919; /* Requested green */
    color: #ffffff; /* White text */
    border: none;
    transition: all 0.3s ease;
  }
  .btn-cart:hover {
    background-color: #3ab015; /* Slightly darker on hover */
    color: #ffffff;
...
function SkinCare() {
  ...
  // All available products (Montessori and educational toys)
  const allProducts = [
    {
      id: 1,
      name: "CHEKORGANICS BODYHUES – Noni Turmeric Soap 100gm",
      price: 600,
      originalPrice: 800,
      image: "https://res.cloudinary.com/dgq3d45tf/image/upload/v1757930696/turmericsoapfront_k3j7hr.webp",
      inStock: true,
      rating: 4.5,
      reviews: 23,
      discount: 25
    ...
    {
      id: 2,
      name: "CHEKORGANICS BODYHUES – Organic Pulpy Papaya De-Tanning Bath Bar (100g)",
      price: 6999,
      originalPrice: 7999,
      image: "https://res.cloudinary.com/dgq3d45tf/image/upload/v1757930696/PapayasweetorangeSoap_xowcdt.webp",
      inStock: true,
      rating: 4.8,
      reviews: 45,
      discount: 13
    ...
    {
      id: 3,
      name: "CHEKORGANICS BODYHUES – Organic Noni Neem Bath Bar (100 g)",
      price: 4999,
      originalPrice: 5999,
      image: "https://res.cloudinary.com/dgq3d45tf/image/upload/v1757930696/Neemsoapimgwebsite_a0qbst.webp",
      inStock: true,
      rating: 4.3,
      reviews: 67,
      discount: 17
    ...
    {
      id: 4,
      name: "CHEKORGANICS BODYHUES – Organic Noni Fruit Bath Bar (100g)",
      price: 5499,
      originalPrice: 6499,
      image: "https://res.cloudinary.com/dgq3d45tf/image/upload/v1757930695/20210705_212210_hy1hua.webp",
      inStock: true,
      rating: 4.6,
      reviews: 34,
      discount: 15
    ...
    {
      id: 5,
      name: "CHEKORGANICS BODYHUES – DUDE Charcoal Peppermint Soap 100gm",
      price: 1299,
      originalPrice: 1599,
      image: "https://res.cloudinary.com/dgq3d45tf/image/upload/v1757930695/Men_Charcoal_soap_kgrwpj.webp",
      inStock: true,
      rating: 4.7,
      reviews: 89,
      discount: 19
    ...
    {
      id: 6,
      name: "CHEKORGANICS BODYHUES – Organic Noni Body Butter (100g)",
      price: 899,
      originalPrice: 1199,
      image: "https://res.cloudinary.com/dgq3d45tf/image/upload/v1757930695/Bodybutter_img_for_ecomm_no_background_y2wtn3.webp",
      inStock: true,
      rating: 4.4,
      reviews: 56,
      discount: 25
    ...
    {
      id: 7,
      name: "CHEKORGANIC BODYHUES – Tulasi Chandan Body Milk | 250gm",
      price: 1499,
      originalPrice: 1799,
      image: "https://res.cloudinary.com/dgq3d45tf/image/upload/v1757930580/sandalwoodbodymilkwithbenefits_2_iax53y.webp",
      inStock: true,
      rating: 4.9,
      reviews: 123,
      discount: 17
    ...
    {
      id: 8,
      name: "CHEKORGANICS BODYHUES – Organic Noni Body Butter (50g)",
      price: 8999,
      originalPrice: 10999,
      image: "https://res.cloudinary.com/dgq3d45tf/image/upload/v1757930527/Bodybutter_img_for_ecomm_no_background_1_fzx8qp.webp",
      inStock: true,
      rating: 4.8,
      reviews: 78,
      discount: 18
    ...
    {
      id: 9,
      name: "CHEKORGANIC BODYHUES – Taruna Gulab Body Milk | 250gm",
      price: 7999,
      originalPrice: 9499,
      image: "https://res.cloudinary.com/dgq3d45tf/image/upload/v1757930523/Kesarbodymilkwithbenefits_wu8gyw.webp",
      inStock: true,
      rating: 4.9,
      reviews: 156,
      discount: 16
    ...
    {
      id: 10,
      name: "CHEKORGANIC BODYHUES – Kesar Patchouli Body Milk | 250gm",
      price: 12999,
      originalPrice: 15999,
      image: "https://res.cloudinary.com/dgq3d45tf/image/upload/v1757930523/cucumberrosebodymilkwithbenefits_2_cs3zmn.webp",
      inStock: true,
      rating: 4.8,
      reviews: 89,
      discount: 19
    ...
    {
      id: 11,
      name: "CHEKORGANICS BODYHUES – Nourishing Noni Lip Balm (Clear/Transparent)",
      price: 3999,
      originalPrice: 4799,
      image: "https://res.cloudinary.com/dgq3d45tf/image/upload/v1757930523/3_741143d7-5083-485e-9b64-969fd8c22a19_dewwdj.webp",
      inStock: true,
      rating: 4.6,
      reviews: 73,
      discount: 17
    ...
    {
      id: 12,
      name: "CHEKORGANICS BODYHUES – Passion Fruit Lip Balm",
      price: 2999,
      originalPrice: 3599,
      image: "https://res.cloudinary.com/dgq3d45tf/image/upload/v1757930522/Nourishing_Noni_open_plain_background_awucwd.webp",
      inStock: true,
      rating: 4.7,
      reviews: 64,
      discount: 17
    ...
    {
      id: 13,
      name: "CHEKORGANICS BODYHUES – Lip Balm Combo Pack",
      price: 5999,
      originalPrice: 6999,
      image: "https://res.cloudinary.com/dgq3d45tf/image/upload/v1757930523/1_efxahk.webp",
      inStock: true,
      rating: 4.5,
      reviews: 112,
      discount: 14
    ...
    {
      id: 14,
      name: "CHEKORGANICS BODYHUES – BOLD BREWTY Coffee Lip Balm",
      price: 9999,
      originalPrice: 11999,
      image: "https://res.cloudinary.com/dgq3d45tf/image/upload/v1757930522/BoldBrewty-coffeelipbalm-withcoffeepowderCloseup_pm2ezi.webp",
      inStock: true,
      rating: 4.9,
      reviews: 187,
      discount: 17
    ...
    {
      id: 15,
      name: "CHEKORGANIC NONI MUKHA LEPAM - Multani Mitti face pack 100gm",
      price: 2499,
      originalPrice: 2999,
      image: "https://res.cloudinary.com/dgq3d45tf/image/upload/v1757930522/NoniMukhaLepamwithprop_ywkawv.webp",
      inStock: true,
      rating: 4.8,
      reviews: 134,
      discount: 17
    ...
    {
      id: 16,
      name: "CHEKORGANIC SANJEEVA THAILAM – 100% Ayurvedic Multipurpose Oil",
      price: 1999,
      originalPrice: 2399,
      image: "https://res.cloudinary.com/dgq3d45tf/image/upload/v1757930522/60_w2th8w.webp",
      inStock: true,
      rating: 4.6,
      reviews: 98,
      discount: 17
      ...
      <div className="container-fluid" style={{ background: "linear-gradient(135deg, #f5f7fa 0%, #c3cfe2 100%)", minHeight: "80vh" }}>
        <div className="container-fluid px-4 py-4">
          ...
          <div className="category-header text-center mb-4">
            <h1 className="display-4 fw-bold mb-2">✨ SKIN CARE</h1>
            <p className="lead mb-0">Nourish your skin with our natural and organic products</p>
          </div>
